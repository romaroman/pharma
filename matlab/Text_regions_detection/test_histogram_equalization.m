...
%
% 1) run on GALLAGER
%    matlab2014a -logfile logs/log.log < test_histogram_equalization.m  &
%
% run VL_FEAT:
% 1)GALLAGER
...
imscale      = 4;
threshold    = 0.1; %0.1;
std_thr      = 10; % = 10;  to avoid long edges
...
save_to      = ['results/test_histogram_equalization/', datestr(now,dateFormat), '/'];
...
% --- Process -------------------------------------------------------------
for n=[60 61 292 361]%[60, 61, 84, 105, 164,  292, 361]%63%[60 61]%1:N
